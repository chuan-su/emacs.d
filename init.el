...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (flx-ido restclient markdown-mode smartparens multiple-cursors evil-nerd-commenter yaml-mode web-mode zenburn-theme project-explorer projectile-rails projectile move-text magit rvm php-mode flycheck dockerfile-mode ido-vertical-mode ido-ubiquitous smex auto-indent-mode auto-complete ac-js2)))
 '(scroll-bar-mode nil)
 '(show-paren-mode t)
 '(tool-bar-mode nil)
